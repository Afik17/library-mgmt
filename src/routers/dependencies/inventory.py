...
from src.repositories.mongodb import MongoDBBookRepo
from src.routers.dependencies.logger import get_transaction_logger
from src.services.inventory import InventoryManager


def get_inventory_repo() -> BookRepo:
    return MongoDBBookRepo()


def get_inventory_manager(
    book_repo: Annotated[BookRepo, Depends(get_inventory_repo)],
